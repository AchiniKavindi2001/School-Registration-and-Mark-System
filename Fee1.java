...
public class Fee1 extends JFrame {
    ...
    private static final String PASSWORD = "achini2001"; // database password
    ...
    public Fee1() {
        ...
        String imagePath = "C:/Users/PCPAL.lk/Pictures/group/One10.jpg"; // Image path
        ...
        area2.setFont(new Font("Serif", Font.PLAIN, 16)); // Slightly smaller for the details text
...
private void openAddMarksWindow() {
    ...
    String imagePath = "C:/Users/PCPAL.lk/Pictures/group/One1.jpg"; // Update with the correct image path
    ImageIcon bgImage = new ImageIcon(imagePath);
...
private void saveStudentDetails() {
    ...
    private void printReceipt() {
        JOptionPane.showMessageDialog(this, "Printing Details...");
